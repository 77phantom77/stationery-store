  ...
  .then(async () => {
    ...
    if (productCount === 0) {
      ...
      await Order.insertMany([
        { date: '10.08.2023', total: 1550, status: 'Доставлен', items: 'Бумага A4, Ручки (2шт)' },
        { date: '05.09.2023', total: 4200, status: 'Передан в службу доставки', items: 'Маркеры, Папки (10шт), Степлер' }
      ]);
